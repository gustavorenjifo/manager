...
(function (root, factory) {
    ...
    embed = function(url, targetSelector, options){
        ...
        var id = (options.id && typeof options.id === "string") ? "id='" + options.id + "'" : "",
            ...
            fallbackHTML = "",
            pdfOpenFragment = "",
            fallbackHTML_default = "<p>Este navegador no soporta lectura PDF dentro del sitio. Por favor descargue el archivo para visualizarlo : <a href='[url]' target='_blank'>Descargar PDF</a></p>";
